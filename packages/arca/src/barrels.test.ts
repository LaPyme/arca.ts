...
import { buildFacturaB, buildFacturaC } from "./services/wsfe-builders";
...
describe("barrel exports", () => {
  it("re-exports runtime factories from the package entrypoints", () => {
    ...
    expect(arca.buildFacturaB).toBe(buildFacturaB);
    expect(arca.buildFacturaC).toBe(buildFacturaC);
    ...
    expect(wsfeBarrel.buildFacturaB).toBe(buildFacturaB);
    expect(wsfeBarrel.buildFacturaC).toBe(buildFacturaC);
